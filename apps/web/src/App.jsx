...
export default function App() {
  ...
  // Read verification token from URL on mount (e.g. /auth/verify?token=...)
  useEffect(() => {
    ...
    <div style={{ padding: "2rem var(--space-8)" }}>
      ...
      >
        ...
        >
          ...
          {/* Section 2: Verify Magic Link Token */}
          <section
            style={{
              border:
                "var(--border-width-thin) solid var(--border-color-default)",
          ...
          {/* Section 3: Third Party Auth (Mock OAuth) */}
          <section
            style={{
              border:
                "var(--border-width-thin) solid var(--border-color-default)",
          ...
          {/* Section 4: Session State & Actions */}
          {accessToken && (
            <section
              style={{
                border:

      ...
      {profile && (
        <>
          ...
          {profile.is_content_hidden ? (
            <section className="rounded-xl border border-border-default bg-surface-elevated p-12 text-center shadow-sm flex flex-col items-center animate-fade-in">
              ...
              <p className="mt-2 max-w-md text-xs text-ink-400 leading-relaxed">
                ...
                articles, posts, and subscriber lists. Follow this user to send
                a follow request.
              </p>
            </section>
          ) : (
            // Public articles tab feed
            <section className="rounded-xl border border-border-default bg-surface-elevated p-8 shadow-sm space-y-6 animate-fade-in">
